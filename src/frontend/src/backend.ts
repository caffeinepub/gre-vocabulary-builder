...
export class Backend implements backendInterface {
    ...
    async addWord(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addWord(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPracticeQuestion(): Promise<Question> {
        if (this.processError) {
            try {
                const result = await this.actor.getPracticeQuestion();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAnswer(arg0: boolean): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAnswer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
